...
describe('PfDrawer', () => {
  it('opens from trigger and emits update:open', async () => {
    ...
    const trigger = w.find('[data-pf-drawer-trigger]');
  ...
  it('renders panel when open is true', async () => {
    ...
    expect(document.body.querySelector('.pfDrawer__panel')).toBeTruthy();
  ...
  it('emits close:prevent when dismissible is false and overlay clicked', async () => {
    ...
    const overlay = document.body.querySelector('.pfDrawer__overlay');
