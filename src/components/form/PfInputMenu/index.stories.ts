...
const meta = {
  title: 'Form/PfInputMenu',
  component: PfInputMenu,
  tags: ['autodocs'],
  decorators: [
    () => ({
      template:
...
} satisfies Meta<typeof PfInputMenu>;
...
export const Default: Story = {
  render: (args) => ({
    components: { PfInputMenu },
    setup() {
      const model = ref<string>('Todo');
      return { args, model };
    },
    template: '<PfInputMenu v-bind="args" v-model="model" />',
  }),
};
...
export const ValueKey: Story = {
  render: (args) => ({
    ...
    template:
      '<PfInputMenu v-bind="args" v-model="model" value-key="id" label-key="label" :items="items" />',
  }),
};
...
export const Groups: Story = {
  render: (args) => ({
    ...
    template: '<PfInputMenu v-bind="args" v-model="model" :items="items" />',
  }),
};
...
export const OpenControlled: Story = {
  render: (args) => ({
    ...
    setup() {
      ...
      return { args, model, open };
    },
    template:
      '<PfInputMenu v-bind="args" v-model="model" v-model:open="open" :open-on-focus="false" />',
  }),
};
